...
<head>
    ...
    <title>Contact Us - Drug Manufacturer Verification System</title>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">PortBell Road, Nakawa-Kampala(U)</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-4">
                            <div
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">+256 394 727 476</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-4">
                            <div
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">info@dvms.com</p>
                            </div>
                        </div>
                    </div>
                </div>
